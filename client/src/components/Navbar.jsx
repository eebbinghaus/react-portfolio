...
const Navbar = () => {
  ...
  return (
    <nav className="w-fill  mx-10 mb-12 flex p-1 justify-between items-center navbar z-[5] mt-10">
       <Link
            className={`font-skranji  cursor-pointer text-[20px] text-black mr-10`}
            aria-current="page"
            to="/"
          >
      ...
      <ul className="list-none sm:flex hidden justify-end items-center flex-1 z-[5]">
        ...
        <li>
          <Link
            className={`font-skranji cursor-pointer text-[20px] text-black `}
            aria-current="page"
            to="/resume"
          >
            Resume
