    ...
    <div className="min-h-screen ">
      <div className="mb-2 flex p-1 justify-around items-center flex-wrap ">
        <div className=" text-center m-10 z-[5]">
          <h1 className="text-white text-[24px] mb-3 font-skranji font-bold">Weather Dashboard</h1>
          <img
            src={weather}
            alt="meal planner"
            className="w-[375px] h-[175px] border-4 border-white shadow-xl shadow-cyan-400/50 mb-6"
          />
          <a
            href="https://eebbinghaus.github.io/weather-dashboard/"
            target="_blank"
            className="text-white font-skranji"
          >
        ...
        <div className=" text-center m-10 z-[5]">
          <h1 className="text-white text-[24px] mb-3 font-skranji font-bold">
        ...
        <div className=" text-center m-10 z-[5]">
          <h1 className="text-white text-[24px] mb-3 font-skranji font-bold">Employee Tracker</h1>
          <img
            src={employeeTracker}
            alt="meal planner"
            className="w-[375px] h-[175px] border-4 border-white shadow-xl shadow-cyan-400/50 mb-6"
        ...
        <div className=" text-center m-10 z-[5]">
          <h1 className="text-white text-[24px] mb-3 font-skranji font-bold">Holiday Wishlist</h1>
          <img
            src={wishlist}
            alt="meal planner"
            className="w-[375px] h-[175px] border-4 border-white shadow-xl shadow-cyan-400/50 mb-6 "
        ...
        <div className=" text-center m-10 z-[5]">
          <h1 className="text-white text-[24px] mb-3 font-skranji font-bold">JavaScript Quiz</h1>
          <img
            src={quiz}
            alt="meal planner"
            className="w-[375px] h-[175px] border-4 border-white shadow-xl shadow-cyan-400/50 mb-6"
